...
const FehuMark = ({ size = 28 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="2" y="2" width="24" height="24" rx="1" fill="#1e1e1e"/>
    <rect x="7" y="4" width="3" height="20" fill="#C9A84C"/>
    <polygon points="10,9 22,3 23,3 23,6 22,6 10,12" fill="#C9A84C"/>
    <polygon points="10,16 22,10 23,10 23,13 22,13 10,19" fill="#C9A84C"/>
  </svg>
);
    ...
    <div style={{ fontFamily: 'system-ui, sans-serif', background: '#080808', color: '#fff', overflowX: 'hidden' }}>
      ...
      <section style={{ padding: '60px 20px', borderTop: '1px solid #141414' }}>
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          ...
          <h2 className="heading" style={{ fontSize: 'clamp(28px, 8vw, 50px)', marginBottom: 32 }}>BUILT FOR TRADERS,<br /><span className="gold">BY TRADERS</span></h2>
      ...
      <section style={{ padding: '60px 20px', background: '#0a0a0a', borderTop: '1px solid #141414' }}>
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          ...
          <h2 className="heading" style={{ fontSize: 'clamp(28px, 8vw, 50px)', marginBottom: 8 }}>EARN POINTS.<br /><span className="gold">CLIMB THE RANKS.</span></h2>
          <div className="divider" />
          <p style={{ fontSize: 14, color: '#666', lineHeight: 1.8, marginBottom: 24 }}>Earn points for every clean day and journal entry. Your total points determine your league — Bronze, Silver, Gold, Diamond, or Platinum. Each league has ranks I, II, and III.</p>
      ...
      <section style={{ padding: '60px 20px', borderTop: '1px solid #141414', textAlign: 'center' }}>
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          <h2 className="heading" style={{ fontSize: 'clamp(32px, 10vw, 60px)', marginBottom: 16 }}>STOP GUESSING.<br /><span className="gold">START WINNING.</span></h2>
          <p style={{ color: '#555', fontSize: 14, marginBottom: 28, lineHeight: 1.7 }}>Join traders building real discipline and finding their edge with STOIX.</p>
          <button className="btn-gold" style={{ maxWidth: 280, margin: '0 auto', display: 'block' }} onClick={() => navigate('/login?signup=true')}>Create Free Account</button>
        </div>
      </section>
